...
private:
   ...
   * Add any helper methods you may need
   */
  int EnergyFirstRow(int row, int col) const;
  int EnergyLastRow(int row, int col) const;
  int EnergyFirstCol(int row, int col) const;
  int EnergyLastCol(int row, int col) const;
  int EnergyNormalCase(int row, int col) const;

  int* TieBrakerVertical(int**& min_array) const;
  int* TieBrakerHorizontal(int**& min_array) const;
};
